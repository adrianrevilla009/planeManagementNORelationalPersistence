...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Dado el nombre de una ciudad y una fecha, listado de los vuelos que han despegado (origen)
        ...
        muestraDatos("Despegues de "+t.getNombre()+" "+t.getApellidos(),tripulanteRepository.despeguesFecha(t.getId()));

        // Para cada tripulante, mostrar su nombre y apellidos junto con su número total de vuelos y la suma de horas de estos.
        muestraDatos("Total de vuelos y suma de horas por tripulante",tripulanteRepository.vuelosHorasPorTripulante());
    }
    ...
    private void cargaDatos() throws ParseException {
        ...
        // Vuelos:
        Vuelo v1 = new Vuelo("IB111","Iberia",av1,ap1,ap2,new SimpleDateFormat("dd/MM/yyyy").parse("29/04/2020"),0.5);
        List<TripulanteVuelo> trip1 = Arrays.asList(new TripulanteVuelo(t1,v1),new TripulanteVuelo(t2,v1));
        v1.setTripulantes(trip1);
        Vuelo v2 = new Vuelo("IB222","Iberia",av2,ap3,ap4,new SimpleDateFormat("dd/MM/yyyy").parse("05/12/2020"),2.5);
        List<TripulanteVuelo> trip2 = Arrays.asList(new TripulanteVuelo(t2,v2),new TripulanteVuelo(t3,v2));
        v2.setTripulantes(trip2);
        Vuelo v3 = new Vuelo("VU111","Vueling",av5,ap4,ap5,new SimpleDateFormat("dd/MM/yyyy").parse("05/02/2021"),1.5);
